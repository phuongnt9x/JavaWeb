...
public class UserServlet extends HttpServlet {
    ...
    private void listUser(HttpServletRequest request, HttpServletResponse response)
        ...
        listUser.sort(((o1, o2) -> o1.getName().compareTo(o2.getName())));
    ...
    private void findUserByCountry(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("listUserFound", listUser);
    ...
    private void findUserForm(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
